                        ...
                        <div class="card shadow">
                            <div class="card-body p-5">
                                ...
                                <form method="POST" action="" id="form">
                                    <div class="mb-3 mt-4 form-control">
                                        <label for="firstName" class="form-label">First Name</label>
                                        <input type="text" class="form-control" id="firstName" name="firstName"
                                            aria-describedby="emailHelp" pattern="[A-Za-z]{3,}" title="Check your full name" minlength="3" required>
                                            <small>Error message</small>
                                    </div>
                                    <div class=" form-control mb-3">
                                        <label for="lastName" class="form-label">last Name</label>
                                        <input type="text" class="form-control" id="lastName" name="lastName"
                                            aria-describedby="emailHelp" pattern="[A-Za-z]{3,}" title="Check your fullname"  minlength="3" required>
                                            <small>Error message</small>
                                    </div>
